...
set CLASSPATH=%APP_HOME%\lib\SaleSystemGUI-1.0.jar;%APP_HOME%\lib\lg-8-tegelinskid-1.0.jar;%APP_HOME%\lib\log4j-core-2.23.1.jar;%APP_HOME%\lib\log4j-api-2.23.1.jar;%APP_HOME%\lib\javafx-fxml-17-mac.jar;%APP_HOME%\lib\javafx-controls-17-mac.jar;%APP_HOME%\lib\hsqldb-2.6.1.jar;%APP_HOME%\lib\hibernate-core-6.2.2.Final.jar;%APP_HOME%\lib\jakarta.persistence-api-3.1.0.jar;%APP_HOME%\lib\commons-dbcp2-2.9.0.jar;%APP_HOME%\lib\javafx-graphics-17-mac.jar;%APP_HOME%\lib\commons-pool2-2.10.0.jar;%APP_HOME%\lib\commons-logging-1.2.jar;%APP_HOME%\lib\javafx-base-17-mac.jar;%APP_HOME%\lib\jakarta.transaction-api-2.0.1.jar;%APP_HOME%\lib\jboss-logging-3.5.0.Final.jar;%APP_HOME%\lib\hibernate-commons-annotations-6.0.6.Final.jar;%APP_HOME%\lib\jandex-3.0.5.jar;%APP_HOME%\lib\classmate-1.5.1.jar;%APP_HOME%\lib\byte-buddy-1.12.18.jar;%APP_HOME%\lib\jaxb-runtime-4.0.2.jar;%APP_HOME%\lib\jaxb-core-4.0.2.jar;%APP_HOME%\lib\jakarta.xml.bind-api-4.0.0.jar;%APP_HOME%\lib\jakarta.inject-api-2.0.1.jar;%APP_HOME%\lib\antlr4-runtime-4.10.1.jar;%APP_HOME%\lib\angus-activation-2.0.0.jar;%APP_HOME%\lib\jakarta.activation-api-2.1.1.jar;%APP_HOME%\lib\txw2-4.0.2.jar;%APP_HOME%\lib\istack-commons-runtime-4.1.1.jar


@rem Execute SaleSystemGUI
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SALE_SYSTEM_GUI_OPTS%  -classpath "%CLASSPATH%" ee.ut.math.tvt.salessystem.ui.SalesSystemUI %*
...
if not ""=="%SALE_SYSTEM_GUI_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
